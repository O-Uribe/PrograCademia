...
// Si se quiere realizar el examen
start_btn.onclick = ()=>{
...
// Si se preciona salir
quit_quiz.onclick = ()=>{
    window.location.reload(); 
}


// Funcion para el boton siguiente donde se comprueba igualmente si es que es la ultima pregunta.
next_btn.onclick = ()=>{
...
// mostrar el arreglo con las preguntas
...
// nuevos div para los iconos
let tickIconTag = '<div class="icon tick"><i class="fas fa-check"></i></div>';
let crossIconTag = '<div class="icon cross"><i class="fas fa-times"></i></div>';

//Cuando se hace clik en las opciones
